...
const state = reactive({
  ...
  blocs: [new Bloc('optimized',5,'a',6,'#85bb2f',5,'main','none','null',1,2),new Bloc('optimized',5,'a',6,'#85bb2f',5,'main','none','null',1,2),new Bloc('optimized',5,'a',6,'#85bb2f',5,'main','none','null',1,2),new Bloc('optimized',5,'a',6,'#85bb2f',5,'main','none','null',1,2)],
  displayedBlocs: [],
  blocFilter: [
    {
      key: 'not covered',
